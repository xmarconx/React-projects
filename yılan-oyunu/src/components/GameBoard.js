...
export default class GameBoard extends Component {
  ...
  onKeyDown = (e) => {
    ...
    switch (e.keyCode) {
      ...
      case 68:
        ...
        break;
      case 80:
        alert('Oyun Duraklatıldı, Oynamaya devam etmek için Tamam veya Enter Tuşuna basın !!');
        break;
      default:
    }
  }
  ...
  onGameOver()
  {
    alert(`Oyun bitti. yılan uzunluğu ${this.state.snakeDots.length -3}. Bu seviyede tekrar oynatmak için Enter Tuşuna basın`);
    this.setState({
      food:getRandomCoordinates(),
      score:0,
      highScore:localStorage.getItem(`${this.state.level}hscore`),
